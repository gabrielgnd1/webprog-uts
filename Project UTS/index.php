...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    // Append the new input array to $all_themeData
    ...
    setcookie('allData', serialize($all_themeData), time() + 300, '/');

    // Redirect to the index.php page
    header('Location: index.php');
    exit();

    print_r($all_themeData);
